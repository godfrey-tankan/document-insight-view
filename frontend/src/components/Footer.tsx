      ...
      <div className="container mx-auto px-6">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="col-span-1 md:col-span-1">
            ...
            <p className="text-teal-200 text-sm mb-6">
              Advanced plagiarism and AI content detection for documents of all kinds.
            </p>
          ...
          <div className="col-span-1">
            ...
            <ul className="space-y-2">
              <li><a href="#" className="text-teal-200 hover:text-white">Plagiarism Detection</a></li>
              <li><a href="#" className="text-teal-200 hover:text-white">AI Content Detection</a></li>
              <li><a href="#" className="text-teal-200 hover:text-white">Citation Checker</a></li>
              <li><a href="#" className="text-teal-200 hover:text-white">Grammar Analysis</a></li>
          ...
          <div className="col-span-1">
            ...
            <ul className="space-y-2">
              ...
              <li><a href="#" className="text-teal-200 hover:text-white">Documentation</a></li>
              <li><a href="#" className="text-teal-200 hover:text-white">API Reference</a></li>
              <li><a href="#" className="text-teal-200 hover:text-white">Community Forum</a></li>
          ...
          <div className="col-span-1">
            ...
            <ul className="space-y-2">
              ...
              <li><a href="#" className="text-teal-200 hover:text-white">Careers</a></li>
        ...
        <div className="border-t border-teal-700 mt-10 pt-6 flex flex-col md:flex-row justify-between items-center">
          ...
          <div className="mt-4 md:mt-0 flex space-x-6">
            <a href="#" className="text-sm text-teal-300 hover:text-white">Privacy</a>
            <a href="#" className="text-sm text-teal-300 hover:text-white">Terms</a>
            <a href="#" className="text-sm text-teal-300 hover:text-white">Cookies</a>
          </div>
        </div>
      </div>
    </footer>
